<?php
	 ...
	 * @author David D�ster
	 * @package JClubCMS
	 * Dieses Modul ist für die Anzeige des G�stebuches verantwortlich,
	...
	/**
	 * Es gibt 3 Actionen, die getrennt ausgef�hrt werden.
	...
	switch ($action) {
		 ...
		 * 
		 * Weiter wird auch der zu kommentierende Beitrag mit allen Komment�ren nochmal angezeigt,
